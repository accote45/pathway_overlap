...
MALACARDS_FOLDER <- "/sc/arion/projects/psychgen/cotea02_prset/geneoverlap_nf/results/dorothea_correlation"
...
ggsave("dumbbell_dorothea_twopanel.pdf", plot = p, width = 12, height = 4.2)