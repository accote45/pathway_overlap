...
write_tsv(baseline, "/sc/arion/projects/psychgen/cotea02_prset/geneoverlap_nf/data/gsa_mixer/baseline.txt")
...
write_tsv(full_gene_rows, "/sc/arion/projects/psychgen/cotea02_prset/geneoverlap_nf/data/gsa_mixer/full_gene.txt")
...
write_tsv(full_gene_set_rows, "/sc/arion/projects/psychgen/cotea02_prset/geneoverlap_nf/data/gsa_mixer/full_gene_set.txt")